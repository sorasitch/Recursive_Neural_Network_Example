...
def save_dataset(symbol='MSFT', time_window='intraday'):
    ...
    if time_window == 'intraday':
        ...
        data, meta_data = ts.get_daily_adjusted('MSFT', outputsize='full')
...
#    save_dataset(time_window='intraday')
    save_dataset(time_window='daily')
#    save_dataset(time_window='daily_adj')
