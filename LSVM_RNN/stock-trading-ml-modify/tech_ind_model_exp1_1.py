...
modelN = Model(inputs=[lstm_input,dense_input # lstm_branch.input, technical_indicators_branch.input
                       # ,lstm_branch1.input, technical_indicators_branch1.input
                       # ,lstm_branch2.input, technical_indicators_branch2.input
                       # ,lstm_branch3.input, technical_indicators_branch3.input
                       ], 
               outputs=[model.output,model1.output,model2.output,model3.output])
modelN.summary()
...
history = modelN.fit([ohlcv_train, tech_ind_train
                      # ,ohlcv_train, tech_ind_train
                      # ,ohlcv_train, tech_ind_train
                      # ,ohlcv_train, tech_ind_train
                      ], 
                     [y_train, y_train1, y_train2, y_train3],
                     batch_size=1024, epochs=50, shuffle=True, validation_split=0.1)
